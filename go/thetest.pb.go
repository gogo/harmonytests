...
func (m *NidOptNativeDefault) String() string { return proto.CompactTextString(m) }
...
func (m *NidOptNativeDefault) GetField1() float64 {
	if m != nil && m.Field1 != nil {
		return *m.Field1
	}
	return Default_NidOptNativeDefault_Field1
}

func (m *NidOptNativeDefault) GetField2() float32 {
	if m != nil && m.Field2 != nil {
		return *m.Field2
	}
	return Default_NidOptNativeDefault_Field2
}

func (m *NidOptNativeDefault) GetField3() int32 {
	if m != nil && m.Field3 != nil {
		return *m.Field3
	}
	return Default_NidOptNativeDefault_Field3
}

func (m *NidOptNativeDefault) GetField4() int64 {
	if m != nil && m.Field4 != nil {
		return *m.Field4
	}
	return Default_NidOptNativeDefault_Field4
}

func (m *NidOptNativeDefault) GetField5() uint32 {
	if m != nil && m.Field5 != nil {
		return *m.Field5
	}
	return Default_NidOptNativeDefault_Field5
}

func (m *NidOptNativeDefault) GetField6() uint64 {
	if m != nil && m.Field6 != nil {
		return *m.Field6
	}
	return Default_NidOptNativeDefault_Field6
}

func (m *NidOptNativeDefault) GetField7() int32 {
	if m != nil && m.Field7 != nil {
		return *m.Field7
	}
	return Default_NidOptNativeDefault_Field7
}

func (m *NidOptNativeDefault) GetField8() int64 {
	if m != nil && m.Field8 != nil {
		return *m.Field8
	}
	return Default_NidOptNativeDefault_Field8
}

func (m *NidOptNativeDefault) GetField9() uint32 {
	if m != nil && m.Field9 != nil {
		return *m.Field9
	}
	return Default_NidOptNativeDefault_Field9
}

func (m *NidOptNativeDefault) GetField10() int32 {
	if m != nil && m.Field10 != nil {
		return *m.Field10
	}
	return Default_NidOptNativeDefault_Field10
}

func (m *NidOptNativeDefault) GetField11() uint64 {
	if m != nil && m.Field11 != nil {
		return *m.Field11
	}
	return Default_NidOptNativeDefault_Field11
}

func (m *NidOptNativeDefault) GetField12() int64 {
	if m != nil && m.Field12 != nil {
		return *m.Field12
	}
	return Default_NidOptNativeDefault_Field12
}

func (m *NidOptNativeDefault) GetField13() bool {
	if m != nil && m.Field13 != nil {
		return *m.Field13
	}
	return Default_NidOptNativeDefault_Field13
}

func (m *NidOptNativeDefault) GetField14() string {
	if m != nil && m.Field14 != nil {
		return *m.Field14
	}
	return Default_NidOptNativeDefault_Field14
}

func (m *NidOptNativeDefault) GetField15() []byte {
	if m != nil {
		return m.Field15
	}
	return nil
